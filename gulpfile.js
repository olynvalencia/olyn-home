...
//OV: font-awesome libe 20151003
gulp.task('font-awesome', function() {
  return gulp
    .src([
      'node_modules/font-awesome/css/*'
    ])
    .pipe(gulp.dest(PATHS.dist + '/lib/font-awesome')); 
});
...
gulp.task('css-fonts', function() {
  return gulp
    ...
    .pipe(gulp.dest(PATHS.dist + '/lib/fonts'));
});
...
gulp.task('images', function() {
  ...
  .pipe(gulp.dest(PATHS.dist + '/lib/images'));
});
...
gulp.task('libs', ['tsd', 'angular2', 'bootstrap', 'font-awesome', 'css-fonts', 'images'], function() {
  return gulp
    .src(PATHS.lib)
